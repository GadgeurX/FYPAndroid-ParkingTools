package com.rcorp.fyp.fypandroid_parkingtools.heatmap;

/**
 * Created by romai on 02/11/2017.
 */
 ...
 */
public class FYPHeatmapTileProvider implements TileProvider {
    ...
    public static class Builder {
         ...
         */
        public FYPHeatmapTileProvider build() {
            ...
            return new FYPHeatmapTileProvider(this);
        }
    }

    private FYPHeatmapTileProvider(Builder builder) {
    ...
    public Tile getTile(int x, int y, int zoom) {
        ...
        for (WeightedLatLng w : points) {
            ...
            if (w.getIntensity() > intensity[bucketX][bucketY])
